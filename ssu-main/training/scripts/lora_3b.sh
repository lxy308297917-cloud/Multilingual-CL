...
# bash training/scripts/lora.sh hau_Latn train5k /data/HwHiAiUser/cl_workspace/ckpt/single_3b_lora/ibo_Latn_train5k
...
if [ -z "${LANG}" ]; then
  ...
  echo "示例2: bash training/scripts/lora.sh hau_Latn train5k /data/HwHiAiUser/cl_workspace/ckpt/single_3b_lora/ibo_Latn_train5k"
  exit 1
fi
...
OUT_ROOT="/data/HwHiAiUser/cl_workspace/ckpt/single_3b_lora"
RUN_LOG_ROOT="/home/HwHiAiUser/cl_workspace/logs/single_3b_lora"
...
echo "========================================"
echo "Single LoRA训练（Qwen2.5-3B-Instruct）"
echo "LANG=${LANG}"

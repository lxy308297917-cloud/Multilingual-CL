...
BASE_MODEL="/data/HwHiAiUser/cl_workspace/Qwen2.5-1.5B"
...
# 输出根目录
OUT_ROOT="/data/HwHiAiUser/cl_workspace/ckpt/single_15b_frombase"

# 日志根目录（单独保存终端日志）
RUN_LOG_ROOT="$HOME/cl_workspace/logs/single_15b_frombase"

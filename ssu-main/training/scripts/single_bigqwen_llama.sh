...
BASE_MODEL="/data/HwHiAiUser/cl_workspace/Llama-3.2-1B-Instruct"
...
# ===== 新数据根目录 =====
DATA_ROOT="/data/HwHiAiUser/cl_workspace/data/fineweb2_big_llama"
HF_CACHE="$HOME/cl_workspace/var/hf_cache"

# 输出根目录
OUT_ROOT="/data/HwHiAiUser/cl_workspace/ckpt/single_15b_fromllama"

# 日志根目录（单独保存终端日志）
RUN_LOG_ROOT="$HOME/cl_workspace/logs/single_15b_fromllama"

...
calibration_dataset_path="/path/to/processed/data/${model_abbrev}_calib_alpaca/"
output_dir="/path/to/models/${model_abbrev}-${lang_code}-ssu_alpaca/"
logging_dir="/path/to/logs/${model_abbrev}-${lang_code}-ssu_alpaca/"

...
output_dir="/path/to/models/${model_abbrev}-${lang_code}-lota_${ratio}/"
logging_dir="/path/to/logs/${model_abbrev}-${lang_code}-lota_${ratio}/"
...
python main.py \
    ...
    --use_lota \
    --lota_sparsity ${ratio} \
    --lota_calibration_steps 100 \
    --lota_grad_accum_steps 1 \
    --lota_optimizer adamw \
